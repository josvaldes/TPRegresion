...
negocios: Cantidad de negocios de conveniencia en las cercanías a
una distancia realizable a pie.
...
# Ejercicio 1.6. 
En la base estudio.xlsx se encuentran registradas las horas de
estudios referidas por un conjunto de estudiantes y su calificación en la evaluación
final.
(a) Ajuste un modelo de regresión simple para estimar la nota final en función
de las horas dedicadas al estudio.
(b) Estudie el cumplimiento de los supuestos del modelo, gráfica y analíticamente.
(c) Ajuste un modelo de mínimos cuadrados ponderados definiendo los pesos
